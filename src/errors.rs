...
pub enum LibreLinkUpError {
    ...
    #[error("Bad credentials. Please ensure that you have entered the credentials of your LibreLinkUp account (and not of your LibreLink account).")]
    BadCredentials,

    #[error("Account temporarily locked due to multiple failed login attempts. Please wait {0} seconds and try again.")]
    AccountLocked(i32),

    #[error("Additional action required for your account: {0}. Please login via app and perform required steps and try again.")]
